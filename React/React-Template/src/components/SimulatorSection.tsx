      ...
      <div style={{ position: 'relative', zIndex: 10, marginTop: '-100vh', width: '100%' }}>
        ...
        <section id="chapter-1" ref={chapter1Ref} style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '50px 0' }}>
          <div style={{
            ...
            <span style={{ color: '#6366f1', fontSize: '10px', fontWeight: 900, letterSpacing: '0.3em', textTransform: 'uppercase' }}>Chapter 1</span>
            <h2 style={{ fontSize: '3.5rem', fontWeight: 900, marginBottom: '20px', letterSpacing: '-0.02em' }}>Survival</h2>
            <p style={{ color: '#888', lineHeight: 1.7, fontSize: '1.1rem', marginBottom: '40px' }}>
        ...
        {/* CHAPTER 2 */}
        <section id="chapter-2" ref={chapter2Ref} style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{
            maxWidth: '550px', padding: '50px', backgroundColor: 'rgba(0,0,0,0.85)', 
            backdropFilter: 'blur(20px)', borderRadius: '40px', border: '1px solid #333', 
            textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.8)'
          }}>
            <span style={{ color: '#6366f1', fontSize: '10px', fontWeight: 900, letterSpacing: '0.3em', textTransform: 'uppercase' }}>Chapter 2</span>
            <h2 style={{ fontSize: '3.5rem', fontWeight: 900, marginBottom: '20px', letterSpacing: '-0.02em' }}>Growth</h2>
        ...
        {/* CHAPTER 3 */}
        <section id="chapter-3" ref={chapter3Ref} style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{
            maxWidth: '550px', padding: '50px', backgroundColor: 'rgba(0,0,0,0.85)', 
            backdropFilter: 'blur(20px)', borderRadius: '40px', border: '1px solid #333', 
            textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.8)'
          }}>
            <span style={{ color: '#6366f1', fontSize: '10px', fontWeight: 900, letterSpacing: '0.3em', textTransform: 'uppercase' }}>Chapter 3</span>
            <h2 style={{ fontSize: '3.5rem', fontWeight: 900, marginBottom: '20px', letterSpacing: '-0.02em' }}>Adulthood</h2>
            <p style={{ color: '#888', lineHeight: 1.7, fontSize: '1.1rem' }}>
        ...
        {/* CHAPTER 4 */}
        <section id="chapter-4" ref={chapter4Ref} style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingBottom: '20vh' }}>
          <div style={{
            maxWidth: '550px', padding: '50px', backgroundColor: 'rgba(0,0,0,0.85)', 
            backdropFilter: 'blur(20px)', borderRadius: '40px', border: '1px solid #333', 
            textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.8)'
          }}>
            <span style={{ color: '#6366f1', fontSize: '10px', fontWeight: 900, letterSpacing: '0.3em', textTransform: 'uppercase' }}>Chapter 4</span>
            <h2 style={{ fontSize: '3.5rem', fontWeight: 900, marginBottom: '20px', letterSpacing: '-0.02em' }}>Final Stage</h2>
            <p style={{ color: '#888', lineHeight: 1.7, fontSize: '1.1rem' }}>
        ...
        {/* CONCLUSION CHART */}
        <section id="conclusion" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '50px 0' }}>
